<?php
  ...
  if ( isset($term->field_feed_logo[LANGUAGE_NONE][0]['fid']) ) {
    $image_url = image_style_url('feed_logo', $term->field_feed_logo[LANGUAGE_NONE][0]['fid']);
    $dimensions = array(
...
<?php if (isset($image_url)):?>
    <media:content url="<?php print $image_url;?>" width="<?php print $image_width;?>" height="<?php print $image_height;?>" />
<?php endif; ?>
